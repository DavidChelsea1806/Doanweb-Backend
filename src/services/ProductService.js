    ...
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            if (checkProduct !== null) {
                resolve({
                    status: 'ERR',
                    message: 'The name or product is already'
                })
            }
            ...
            console.log("respone", createProduct)
            if (createProduct) {
                resolve({
                    status: 'OK',
                    message: 'SUCCESS',
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (sort) {
                ...
                const allProductSort = await Product.find().limit(limit).skip(page * limit).sort(objectSort).sort(objectSort)
                resolve({
                    status: 'OK',
                    message: 'Success',
                    data: allProductSort,
